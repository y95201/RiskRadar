 ...
 * 巡检日志管理
 *
 * @property RiskLogService $service
 */
class RiskLogController extends AdminController
{
	protected string $serviceName = RiskLogService::class;
	...
	public function list()
	{
		$crud = $this->baseCRUD()
			...
			->columns([
				...
				amis()->TableColumn('target_id', '目标ID(offerId)'),
				...
				amis()->TableColumn('checked_at', '检测时间')->type('datetime'),
	...
	public function form($isEdit = false)
	{
		return $this->baseForm($isEdit)->body([
			...
			amis()->TextControl('target_id', '目标ID(offerId)')->required(),
	...
	public function detail()
	{
		return $this->baseDetail()->body([
			...
			amis()->TextControl('target_id', '目标ID(offerId)')->static(),
